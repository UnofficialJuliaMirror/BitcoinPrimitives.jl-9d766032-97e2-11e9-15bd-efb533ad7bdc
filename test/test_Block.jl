@testset "Block" begin
    ...
    #     block = Header(stream)
    #     @test BitcoinPrimitives.serialize(block) == block_raw
    # end
    # @testset "Hash" begin
    #     block_raw = hex2bytes("020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d")
    #     stream = IOBuffer(block_raw)
    #     block = Header(stream)
    #     BitcoinPrimitives.hash(block) == hex2bytes("0000000000000000007e9e4c586439b0cdbe13b1370bdd9435d76a644d047523")
    # end
    # @testset "BIP9" begin
    #     block_raw = hex2bytes("020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d")
    #     stream = IOBuffer(block_raw)
    #     block = Header(stream)
    #     @test BitcoinPrimitives.bip9(block)
    ...
    #     stream = IOBuffer(block_raw)
    #     block = Header(stream)
    #     @test BitcoinPrimitives.bip91(block)
    #     block_raw = hex2bytes("020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d")
    #     stream = IOBuffer(block_raw)
    #     block = Header(stream)
    #     @test !BitcoinPrimitives.bip91(block)
    ...
    #     stream = IOBuffer(block_raw)
    #     block = Header(stream)
    #     @test BitcoinPrimitives.bip141(block)
    ...
    #    block = Header(stream)
    #    @test BitcoinPrimitives.validate_merkle_root(block, hashes)
    # end
end
